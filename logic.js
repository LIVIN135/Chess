...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 == 0) {
            color.style.backgroundColor = 'rgb(250 235 239)'
        }
        if (a % 2 !== 0) {
            color.style.backgroundColor = 'rgb(120 150 120)'
        }
    })
}
coloring()
            ...
            document.querySelectorAll('.box').forEach(i2 => {
                ...
                if (i2.style.backgroundColor == 'greenyellow' && i2.innerText.length !== 0) {
                    ...
                    if (a % 2 == 0 && blueColor == greenyellowColor) {
                        i2.style.backgroundColor = 'rgb(232 100 239)'
                    }
                    if (a % 2 !== 0 && blueColor == greenyellowColor) {
                        i2.style.backgroundColor = 'rgb(205 100 150)'
                    }
